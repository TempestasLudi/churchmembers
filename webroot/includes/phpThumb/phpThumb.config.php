...
$PHPTHUMB_CONFIG['error_message_image_default'] = '../../css/images/users/delete_image.png';       // Set this to the name of a generic error image (e.g. '/images/error.png') that you want displayed in place of any error message that may occur. This setting is overridden by the 'err' parameter, which does the same thing.
